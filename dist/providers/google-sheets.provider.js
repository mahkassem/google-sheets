...
var authenticate = __importStar(require("google-auth-library"));
...
// time.
var CREDENTIALS_JSON_FILE_PATH = process.env.CREDENTIALS_JSON_FILE_PATH;
console.log('CREDENTIALS_JSON_FILE_PATH', CREDENTIALS_JSON_FILE_PATH);
var TOKEN_PATH = path_1.default.join(process.cwd(), 'token.json');
var CREDENTIALS_PATH = path_1.default.join(process.cwd(), '....', CREDENTIALS_JSON_FILE_PATH);
/**
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sheets.spreadsheets.values.get({
                            spreadsheetId: '1nuArYSaeBBcJQcBXqFY9F8a2hrD0OaPPvweQMz38zWI',

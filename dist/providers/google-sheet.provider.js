...
var GoogleSheetProvider = /** @class */ (function () {
    function GoogleSheetProvider() {
        // range
        this.range = 'ContactMessage!A2:G';
    ...
    GoogleSheetProvider.prototype.getMessages = function () {
    ...
    GoogleSheetProvider.prototype.addMessage = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var utcDate, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        utcDate = luxon_1.DateTime.utc().toFormat('yyyy-MM-dd HH:mm:ss');
